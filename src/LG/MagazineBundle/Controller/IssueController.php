...
use LG\MagazineBundle\Entity\Issue;
use LG\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $issues = $em->getRepository('LGMagazineBundle:Issue')->findAll();
    ...
    {
        $issue = new Issue();
        $form = $this->createForm('LG\MagazineBundle\Form\IssueType', $issue);
    ...
    {
        $deleteForm = $this->createDeleteForm($issue);
        $editForm = $this->createForm('LG\MagazineBundle\Form\IssueType', $issue);
