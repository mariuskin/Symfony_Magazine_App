...
use LG\MagazineBundle\Entity\Publication;
use LG\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $publications = $em->getRepository('LGMagazineBundle:Publication')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('LG\MagazineBundle\Form\PublicationType', $publication);
    ...
    {
        $deleteForm = $this->createDeleteForm($publication);
        $editForm = $this->createForm('LG\MagazineBundle\Form\PublicationType', $publication);
